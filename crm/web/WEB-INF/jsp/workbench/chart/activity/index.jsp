...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                url:'workbench/chart/activity/activityPieChart.do',
                type:'post',
                datatype:"json",
            ...
            $.ajax({
                url:'workbench/chart/activity/queryCountOfActivityInProgressGroupByOwner.do',
                type:'post',
                datatype:"json",
                success:function (data){
            ...
            $.ajax({
                url:'workbench/chart/activity/queryCountOfActivityByCreateMonth.do',
                type:'post',
                datatype:"json",
                success:function (data){
            ...
            $.ajax({
                url:'workbench/chart/activity/queryCountOfActivityByOwnerAndCreate.do',
                type:'post',
                datatype:"json",
                success:function (data){
                    ...
                    let option = {
                        // color: ['#c23531'],
                        title: {//标题
                            text: year+'年'+month+'月创建市场活动Top10',
                            // subtext: '测试副标题',
                            // textStyle: {
                            //     fontStyle: 'italic'
                            // }
